 ...
 * Changes:
 *  - Removed implicit Boolean boxing
 *  - Removed hiding of field with same name
 */
...
final class FlashlightManager {
  ...
  static {
    ...
    // JB: removed: setFlashEnabledMethod = getSetFlashEnabledMethod(iHardwareService);
    setFlashEnabledMethod = getSetFlashEnabledMethod(); // JB: added
  ...
  // JB: removed:  private static Method getSetFlashEnabledMethod(Object iHardwareService) {
  private static Method getSetFlashEnabledMethod() { // JB: added
    if (iHardwareService == null) {
      return null;
    }
  ...
  private static void setFlashlight(boolean active) {
    if (iHardwareService != null) {
    	// JB: removed: invoke(setFlashEnabledMethod, iHardwareService, active);
    	invoke(setFlashEnabledMethod, iHardwareService, Boolean.valueOf(active)); // JB: added
    }
  }
